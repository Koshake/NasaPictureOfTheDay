...
class NotesRepositoryImpl : NotesRepository {
    ...
    private val notes: MutableList<NotesData> = mutableListOf(
        NotesData(1, "Note 1", "1"),
        NotesData(2, "Note 2", "2"),
        NotesData(3, "Note 3", "3"),
        NotesData(4, "Note 4", "4"),
        NotesData(5, "Note 5", "5"),
        NotesData(6, "Note 6", "6"),
        NotesData(7, "Note 7", "7"),
        NotesData(8, "Note 8", "8"),
    )
